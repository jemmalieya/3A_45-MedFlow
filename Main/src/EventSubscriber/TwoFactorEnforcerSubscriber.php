...
final class TwoFactorEnforcerSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            // Must run *after* the Security firewall (otherwise TokenStorage has no token yet).
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        // Trusted device cookie: if valid, mark session as passed and continue.
        if ($this->rememberDevice->isRemembered($request, $user)) {
