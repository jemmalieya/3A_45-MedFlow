 ...
 */
final class Version20260208234223 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP google_id, DROP role_systeme, DROP type_staff, DROP verification_token, DROP token_expires_at, DROP staff_request_status, DROP staff_request_type, DROP staff_request_message, DROP staff_requested_at, DROP staff_reviewed_at, DROP staff_reviewed_by');
    }
}
