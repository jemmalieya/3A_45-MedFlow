 ...
 */
final class Version20260212134542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, localisation VARCHAR(255) NOT NULL, img_post VARCHAR(255) NOT NULL, hashtags VARCHAR(255) DEFAULT NULL, visibilite VARCHAR(50) NOT NULL, date_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_modification DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', est_anonyme TINYINT(1) NOT NULL, categorie VARCHAR(255) NOT NULL, humeur VARCHAR(255) NOT NULL, nbr_reactions INT NOT NULL, nbr_commentaires INT NOT NULL, INDEX IDX_5A8A6C8DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
